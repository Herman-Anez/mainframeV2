# Lookahead (Inspección hacia adelante)
...
1.  El motor alcanza la posición donde aparece el lookahead.
2.  Intenta emparejar la subexpresión interna contra el texto desde esa posición.
3.  Si tiene éxito (lookahead positivo) o fracaso (lookahead negativo), la aserción se considera satisfecha; en caso contrario, falla y la coincidencia global retrocede.
4.  El puntero de búsqueda vuelve exactamente a la posición inicial.
...
Los lookaheads están soportados en todos los motores modernos: JavaScript, Python (`re`), Java, .NET, PCRE, Perl, etc. La sintaxis es universal.

> [!IMPORTANT]
> La única diferencia es que en motores que no permiten lookbehind, a veces hay que simularlos (pero lookahead siempre funciona).
...
| :--- | :---: | ---: |
| [◀ Grupos Atómicos](../03_agrupaciones_y_captura/05_grupos_atomicos.md) | [🏠 Inicio](../../README.md) | [Lookbehind ▶](02_lookbehind.md) |
