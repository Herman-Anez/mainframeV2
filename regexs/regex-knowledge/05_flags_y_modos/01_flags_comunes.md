...
Estas son las flags más comunes, compatibles en la mayoría de los motores de búsqueda:
...
| **m** | Multiline | Cambia el significado de `^` y `$` para que coincidan con inicio/fin de cada línea. |
...
| **A / a** | ASCII-only (Python) | Fuerzan que `\w`, `\d`, `\s`, `\b` solo reconozcan caracteres ASCII. |
...
> [!NOTE]
> Algunos motores tienen una flag `m` para multilínea y `s` para dotall. No confundir sus propósitos.
...
Esto permite granularidad sin modificar el resto del patrón.
...
> [!WARNING]
> JavaScript **NO** soporta flags inline. Solo se aplican globalmente en el constructor o literal.

---

| Anterior | Inicio | Siguiente |
| :--- | :---: | ---: |
| [◀ Ejemplos de Validación](../04_aserciones/03_ejemplos_validacion.md) | [🏠 Inicio](../../README.md) | [Modo Verboso ▶](02_modo_verboso.md) |
